...
2. `brand-kit.md` â€” look for a reference image path and brand colours
3. `about-me.md` â€” for the creator's name and positioning
...
- My expression: [tone details â€” e.g., shocked with wide eyes and open mouth]
- My gaze: [direction â€” e.g., looking directly at camera / looking off-frame toward the text]
...
- Primary: [hex]
- Accent: [hex]
- Background: [hex] â€” [describe treatment: flat, gradient, blurred scene, etc.]
...
- Never include the reference photo path in the prompt itself â€” the user attaches the photo separately.
