...
- **Footer CTA**: handwritten text reading "Follow [Name] [Tagline] for more helpful content | Repost â™»ï¸"
...
[INSERT THE BRIEF HERE â€” title, subtitle, core structure, key points, visual suggestions]
...
Always include the handwritten text "Follow [Name] [Tagline] for more helpful content | Repost â™»ï¸" at the bottom of the image, in the same hand-drawn marker style.
```
